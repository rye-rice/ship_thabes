...
/obj/machinery/computer
	retro_icon = 'modular_event/oldaesth/computer.dmi'
	can_retroify = TRUE

/obj/machinery/modular_computer/console
	retro_icon = 'modular_event/oldaesth/modular_console.dmi'
	can_retroify = TRUE

/obj/machinery/power/smes
	retro_icon = 'modular_event/oldaesth/smes.dmi'
	can_retroify = TRUE

/obj/machinery/power/apc
	retro_icon = 'modular_event/oldaesth/power.dmi'
	can_retroify = TRUE

/obj/machinery/rnd
	retro_icon = 'modular_event/oldaesth/research.dmi'
	can_retroify = TRUE

/obj/machinery/autolathe
	retro_icon = 'modular_event/oldaesth/stationobjs.dmi'
	can_retroify = TRUE
